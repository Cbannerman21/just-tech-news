...
User.init(
    {
       // define an id column
       id: {
           // use the special Sequlize DataTypes object to provide what type of data it is
       ...
       email: {
           ...
           unique: true,
           // if allowNull is set to false, we can run our data thjrough validators before creating the table data
           validate: {
               isEmail: true
           }
       },
